...
public:
	...
	void kFN_query(CQrySeg& qry_seg, const float qry_loc, CQry& qry, const vector<pair<int, pair<float, float>>>& sorted_obj_seg_list);
	...
	map<int, CQrySeg>& get_m_map_qry_seg() { return m_map_qry_seg; }
	map<int, CQry>& get_m_map_qry() { return m_map_qry; }
